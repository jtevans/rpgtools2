      ...
      >
        <Box sx={style} ref={gridRef}>
          ...
          <Typography sx={{ textAlign: "center" }} variant="h5" component="h2">
            <ContentCopyIcon sx={{ paddingRight: "5px", fontSize: "12pt" }} onClick={handleCopy} />1st Edition Wizard Spellbook<ReplayIcon sx={{ paddingLeft: "5px", fontSize: "10pt" }} onClick={() => getSpells()} />
          </Typography>
          <Typography>
            <SpellsList />
          </Typography>
