...
export default function EstablishmentNames() {
  const handleOpen = () => {
    getNames();
  }
  const handleClose = () => {
  ...
  return (
    <React.Fragment>
      <Button onClick={handleOpen}>Establishment Names</Button>
      {names && <Modal
        open={names != null}
      ...
      >
        <Box sx={style} ref={gridRef}>
          ...
          <Typography sx={{ textAlign: "center" }} variant="h5" component="h2">
            <ContentCopyIcon sx={{ paddingRight: "5px", fontSize: "12pt" }} onClick={handleCopy} />Establishment Names<ReplayIcon sx={{ paddingLeft: "5px", fontSize: "10pt" }} onClick={() => getNames()} />
          </Typography>
